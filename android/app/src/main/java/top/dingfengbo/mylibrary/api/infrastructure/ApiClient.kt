package top.dingfengbo.mylibrary.api.infrastructure

import top.dingfengbo.mylibrary.api.auth.HttpBearerAuth
...
import top.dingfengbo.mylibrary.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "top.dingfengbo.mylibrary.api.baseUrl"
        @Deprecated(
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(BASE_URL_KEY, "http://127.0.0.1:8000")
        }
    }
}
